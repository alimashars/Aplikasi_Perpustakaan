        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped text-center" id="datatable">
            ...
            <tbody>
              <?php if (!empty($wishlist)): ?>
                <?php $no = 1; foreach ($wishlist as $w): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('wishlist/edit/' . $w->id_wishlist) ?>" 
                         class="btn btn-sm btn-warning mr-1" 
                         title="Edit Wishlist">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a href="<?= base_url('wishlist/hapus/' . $w->id_wishlist) ?>" 
              ...
              <?php else: ?>
                <tr>
                  <td colspan="5" class="text-center">Belum ada buku dalam wishlist Anda.</td>
                </tr>
              <?php endif; ?>
            </tbody>
          </table>
